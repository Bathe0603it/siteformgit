                ...
                <div class="box box-info">
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input class="form-control" data-val="true" data-val-length="Họ của người dùng không dài quá 50 ký tự" data-val-length-max="50" id="LastName" name="LastName" placeholder="Nhập Họ" type="text" value="">
                                        <div class="has-error">
                                            <span class="help-block"><span class="field-validation-valid help-block" data-valmsg-for="LastName" data-valmsg-replace="true"></span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input class="form-control" data-val="true" data-val-length="Tên của người dùng không dài quá 50 ký tự" data-val-length-max="50" data-val-required="Nhập vào tên của người dùng" id="FirstName" name="FirstName" placeholder="Nhập Tên" type="text" value="">
                                        <div class="has-error">
                                            <span class="help-block"><span class="field-validation-valid help-block" data-valmsg-for="FirstName" data-valmsg-replace="true"></span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label class="control-label strong" for="Url">Trang chủ</label>
                                    <span class="text-muted">(tùy chọn)</span>
                                    <div class="controls">
                                        <input class="form-control" data-val="true" data-val-length="Trang chủ không dài quá 128 ký tự" data-val-length-max="128" id="Url" name="Url" placeholder="Nhập Trang chủ" type="text" value="">
                                        <div class="has-error">
                                            <span class="help-block"><span class="field-validation-valid help-block" data-valmsg-for="Url" data-valmsg-replace="true"></span></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <div class="controls">
                                        <div class="checkbox">
                                            <label class="strong">
                                                <input id="ReceivedAnnouncements" name="ReceivedAnnouncements" type="checkbox" value="true"><input name="ReceivedAnnouncements" type="hidden" value="false">
            ...
            <div class="panel panel-default panel-light">
                <div class="panel-body">
                    <div class="form-group">
                        <div class="checkbox">
                            <label class="strong">
                            <input bind="isLimitAccess" id="LimitedAccess" name="LimitedAccess" type="checkbox" value="true"><input name="LimitedAccess" type="hidden" value="false">
                            Giới hạn quyền truy cập <span></span>
                            </label>
                        </div>
                    </div>
                    <div class="row hide all-roles" bind-show="isLimitAccess">
                        <div class="col-sm-4">
                            <div class="form-group">
