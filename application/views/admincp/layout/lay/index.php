...
<html>
    <head>
        ...
        <!-- Bootstrap 3.3.6 -->
        <link rel="stylesheet" href="<?php echo admin_template_url();?>bootstrap/css/bootstrap.min.css">
        <!-- Font Awesome -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
        <!-- Ionicons -->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
        <!-- Theme style -->
        <link rel="stylesheet" href="<?php echo admin_template_url();?>dist/css/AdminLTE.min.css">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
			<?php
			    ...
			    $this->load->view('admincp/layout/aside');
			?>
		    	...
		    	<!-- /.content-wrapper -->
		    	<?php
			    $this->load->view('admincp/layout/footer');
			?>
			<!-- Control Sidebar -->
        ...
        <!-- Slimscroll -->
        <script src="<?php echo admin_template_url();?>plugins/slimScroll/jquery.slimscroll.min.js"></script>
        <!-- FastClick -->
        <script src="<?php echo admin_template_url();?>plugins/fastclick/fastclick.js"></script>
        <!-- AdminLTE App -->
